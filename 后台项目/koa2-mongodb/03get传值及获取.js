...
router.get('/newscontent',async (ctx)=>{
    //url:         http://localhost:3001/newscontent?name=123&sd=99
    console.log(ctx.query);//Object: null prototype] { name: '123', sd: '99' }//推荐用法
    console.log(ctx.querystring);//name=123&sd=99
    ctx.body="新闻详情";
});
