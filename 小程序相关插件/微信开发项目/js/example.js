...
/***/ function(module, exports, __webpack_require__) {
	...
	_fastclick2.default.attach(document.body);
        ...
        document.querySelector('#tmp-icon1').addEventListener('click', function (e) {
            var target = e.target;
            ...
            _weui2.default.gallery(url);
        });

        document.querySelector('#tmp-icon2').addEventListener('click', function (e) {
            var target = e.target;
        ...
        document.querySelector('#tmp-icon3').addEventListener('click', function (e) {
            var target = e.target;
	...
	var uploadCustomFileList2 = [];
	var uploadCustomFileList3 = [];

	// 这里是简单的调用，其余api请参考文档
	_weui2.default.uploader('#uploaderCustom1', {
	    url: '/merchant/upload',
	    auto: true,
        compress: {
            width: 800,
        ...
        onSuccess: function (ret) {
            console.info('----');
            console.info(ret.url);
            $("#idcard_face_url").val(ret.url);
        }
	});

	// 这里是简单的调用，其余api请参考文档
	_weui2.default.uploader('#uploaderCustom2', {
		url: '/merchant/upload',
        auto: true,
        compress: {
            width: 800,
        ...
        onSuccess: function (ret) {
            console.info('----');
            console.info(ret.url);
            $("#idcard_back_url").val(ret.url);
        }
	});

	// 这里是简单的调用，其余api请参考文档
	_weui2.default.uploader('#uploaderCustom3', {
		url: '/merchant/upload',
        auto: true,
        compress: {
            width: 800,
        ...
        onSuccess: function (ret) {
			console.info('----');
            console.info(ret.url);
            $("#idcard_hand_url").val(ret.url);
        }
	});

	// 手动上传按钮
	document.getElementById("uploaderIdCardFaceBtn").addEventListener('click', function () {
	    uploadCustomFileList1.forEach(function (file) {
	        file.upload();
	    });
	});
	// 手动上传按钮
	document.getElementById("uploaderIdCardBackBtn").addEventListener('click', function () {
	    uploadCustomFileList2.forEach(function (file) {
	        file.upload();
	    });
	});
	// 手动上传按钮
	document.getElementById("uploaderIdCardHandBtn").addEventListener('click', function () {
	...
	// 缩略图预览
	document.querySelector('#idcard_face_tmp').addEventListener('click', function (e) {
	    var target = e.target;
        ...
        var gallery = _weui2.default.gallery(url, {
            onDelete: function onDelete() {
                _weui2.default.confirm('确定删除该图片？', function () {
                    ...
                    if (index) uploadCustomFileList1.splice(index, 1);
	...
	// 缩略图预览
	document.querySelector('#idcard_back_tmp').addEventListener('click', function (e) {
	    var target = e.target;
        ...
        var gallery = _weui2.default.gallery(url, {
            onDelete: function onDelete() {
                _weui2.default.confirm('确定删除该图片？', function () {
                    ...
                    if (index) uploadCustomFileList2.splice(index, 1);
	...
	// 缩略图预览
	document.querySelector('#idcard_hand_tmp').addEventListener('click', function (e) {
	    var target = e.target;
	    ...
	    var gallery = _weui2.default.gallery(url, {
	        onDelete: function onDelete() {
	            _weui2.default.confirm('确定删除该图片？', function () {
	                ...
	                if (index) uploadCustomFileList3.splice(index, 1);
