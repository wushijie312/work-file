...
import { Button,Select,Modal,Table, Divider,Popconfirm } from 'antd';
import { selectTasksMenu ,fetchTasks,removeTask,enqueueTask,enqueueALLTask} from '../../actions'
import './style.css';
...
info = (item) => {
  ...
  render() {
    let { currenQueueList } = this.props;
